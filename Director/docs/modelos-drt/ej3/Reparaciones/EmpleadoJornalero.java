...
public class EmpleadoJornalero extends Tecnico{
	private double tarifaPorHora;

	public EmpleadoJornalero(String nombres, String apellidos,
			String documentoUnico, double tarifaPorHora, boolean activo) {
